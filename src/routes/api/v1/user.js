...
import { changeCoverPhoto, changePassword, changeProfilePhoto, createAdminUser, deleteUser, fetchAllUsers, fetchAllUserByRole, fetchOneUserById, updateUser } from '../../../controllers/userController.js'
...
UserRoutes.get('/users/:role', fetchAllUserByRole)
